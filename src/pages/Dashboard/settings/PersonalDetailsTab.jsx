...
const PersonalDetailsTab = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <p className="text-sm text-gray-500 mt-1">Manage and update your personal information. This helps us keep your account accurate and personalized.</p>
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input type="text" value={formData.first_name} disabled className="w-full p-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed" />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
          <input type="text" value={formData.last_name} disabled className="w-full p-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed" />
        </div>
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
          <input type="email" value={formData.email} disabled className="w-full p-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed" />
        </div>
        <div>
          <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
          <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleInputChange} className="w-full p-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500" />
        </div>
        <div>
      ...
      <div className="mt-8">
        <button type="submit" className="w-full md:w-auto px-8 py-2.5 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 cursor-pointer">
          Save Changes
        </button>
      </div>

      <div className="mt-6 p-4 bg-gray-100 rounded-lg text-sm text-gray-600">
        You can only update your phone number and institution. For changes to other details, please contact <a href="mailto:support@studex.com" className="font-semibold text-purple-600">support@studex.com</a>.
      </div>
    </div>
    </form>
    </div>
