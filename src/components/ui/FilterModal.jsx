...
const conditions = ["new", "good", "like-new", "fair", "poor"];
const locations = ["lagos", "abuja", "rivers", "kano", "oyo", "kaduna"];
...
const FilterModal = ({ isOpen, onClose, onApplyFilters }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-white w-full max-w-sm h-full flex flex-col transform transition-transform duration-300 ease-in-out ${
